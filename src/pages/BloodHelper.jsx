...
export default function BloodHelper() {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hello! I'm Blood Helper, your donation assistant. I can help you with information about blood donation, eligibility, health benefits, and answer any questions you might have. How can I assist you today?",
    },
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (lowerInput.includes("eligib") || lowerInput.includes("qualify") || lowerInput.includes("can i donate")) {
        response = predefinedResponses.eligibility;
      } else if (lowerInput.includes("benefit") || lowerInput.includes("advantage") || lowerInput.includes("why should")) {
        response = predefinedResponses.benefits;
      } else if (lowerInput.includes("process") || lowerInput.includes("how to") || lowerInput.includes("procedure")) {
        response = predefinedResponses.process;
      } else if (lowerInput.includes("prepar") || lowerInput.includes("before donating")) {
        response = predefinedResponses.preparation;
      } else if (lowerInput.includes("after") || lowerInput.includes("care") || lowerInput.includes("recovery")) {
        response = predefinedResponses.aftercare;
      } else if (lowerInput.includes("hello") || lowerInput.includes("hi") || lowerInput.includes("hey")) {
        response = "Hello! I'm here to help with blood donation information. You can ask me about:\n\n• Eligibility criteria\n• Health benefits\n• Donation process\n• Preparation tips\n• Aftercare advice\n\nWhat would you like to know?";
      } else if (lowerInput.includes("blood type") || lowerInput.includes("blood group")) {
        response = "There are 8 main blood types:\n\n🅰️ A+ (35.7%)\n🅰️ A- (6.3%)\n🅱️ B+ (8.5%)\n🅱️ B- (1.5%)\n🆎 AB+ (3.4%)\n🆎 AB- (0.6%)\n🅾️ O+ (37.4%)\n🅾️ O- (6.6%)\n\nO- is the universal donor, AB+ is the universal recipient. All blood types are needed!";
      } else if (lowerInput.includes("thank")) {
        response = "You're welcome! Remember, every blood donation can save up to 3 lives. Thank you for considering becoming a donor! 🩸❤️";
      } else {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto">
            Get instant answers about blood donation, eligibility, benefits, and more
          </p>
        </div>
                  ...
                  >
                    {message.role === "assistant" && (
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-bold text-rose-600">Blood Helper</span>
                      </div>
                    )}
